...
const createStateContext = (initialState, contextOptions) => {
    ...
    const Provider = (props) => {
        ...
        const updateState = React.useCallback((prevState, updatedState) => {
        ...
        const handleState = React.useCallback((updatedState) => {
            setState((prevState) => {
    ...
    const useCtx = (keys) => {
        ...
        return React.useMemo(() => ({ ...pick_1(c.state, keys), setState: c.setState }), [c.setState, c.state, keys]);
    };

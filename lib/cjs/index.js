...
const createStateContext = (initialState, contextOptions) => {
    ...
    const Provider = (props) => {
        ...
        const [state, setState] = useStateSafe(() => {
            const firstState = merge_1({}, initialState, defaultState);
        ...
        return (jsxRuntime$1.exports.jsx(ctx.Provider, { value: { state: controlledState ? merge_1({}, state, controlledState) : state, setState: handleState }, children: children }));
    };
    const useCtx = (keys) => {

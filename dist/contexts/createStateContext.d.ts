...
declare const createStateContext: <S extends DeepRecord<string, unknown>>(initialState: S, contextOptions?: StateContextOptions<S> | undefined) => [<P extends Path<S>>(keys: P[]) => { [K in P]: PathValue<S, K>; } & Pick<StateRef<S>, "setState">, (props: React.PropsWithChildren<StateProviderProps<S>>) => JSX.Element];
